...
function printAllProducts(array) {
...
function printCheaperThan(num, array) {
  let result = array.filter((element) => element.price < num);
  console.log(result);
}
...
function getCheapestProduct(array) {
  let prices = array.map((element) => element.price);

  let result = prices.reduce(
...
function getUniqueCategories(array) {
  let categories = array.map((element) => element.category);
...
function drawCategories(array) {
  let mainDiv = document.getElementById("products");

  let btnContainer = document.createElement("div");
  btnContainer.className = "categories-container";

  mainDiv.parentNode.insertBefore(btnContainer, mainDiv);
  ...
  array.forEach((category) => {
    ...
    button.addEventListener("click", function () {
      let allButton = document.querySelectorAll(".category-btn");
  ...
  array.forEach((category) => {
    ...
    button.addEventListener("click", function () {
      ...
      if (button.style.backgroundColor !== "red") {
        ...
        let clickedCategory = shopData.filter(
          (element) => element.category === category
        );
        console.log(clickedCategory);

        render(clickedCategory);
      } 
    });
    btnContainer.appendChild(button);
  });
...
function renderFromAPI(){
    ...
    .then((data) => {
        ...
        drawCategories(getUniqueCategories(data))
    })
    .catch((error) => {
